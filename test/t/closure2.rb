# TODO: Expected this way, But crashed now, mruby dynamic class bug?
#compar = CFunc::Closure.new(CFunc::Int, [CFunc::Pointer(CFunc::Int), CFunc::Pointer(CFunc::Int)
#  a.refer.to_i - b.refer.to_i
#end

compar = CFunc::Closure.new(CFunc::Int, [CFunc::Pointer, CFunc::Pointer]) do |a, b|
  CFunc::Int.refer(a).to_i - CFunc::Int.refer(b).to_i
end
